...
class OwnerChatListScreen extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    final conversations = MockChats.ownerConversations;
    return Scaffold(
      ...
      body: conversations.isEmpty
          ? const EmptyState(
              ...
              message: 'Messages from interested buyers will appear here.',
            )
          : ListView.separated(
              ...
              itemBuilder: (context, i) {
                ...
                return ListTile(
                  onTap: () => context.push(RoutePaths.ownerChatDetail(c.id)),

...
class _ChatDetailScreenState extends State<ChatDetailScreen> {
  ...
  void initState() {
    super.initState();
    _conversation = MockChats.buyerConversations.firstWhere(
      (c) => c.id == widget.conversationId,
      orElse: () => MockChats.buyerConversations.first,
    );
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: GestureDetector(
          onTap: () => context.push(RoutePaths.buyerAgentProfile(_conversation.property.agent.id)),
          child: Row(
            children: [
      ...
      body: Column(
        children: [
          GestureDetector(
            onTap: () => context.push(RoutePaths.buyerPropertyDetails(_conversation.property.id)),
            child: Container(
  ...
  void _callDialog(BuildContext context) {
    showDialog(
      ...
      builder: (context) => AlertDialog(
        ...
        content: Text(_conversation.property.agent.phone),
        actions: [
